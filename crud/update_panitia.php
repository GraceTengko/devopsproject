...
<head>
    ...
    <title>Update Data Panitia</title>
    ...
    <div class="d-flex">
        ...
        <div class="content col">
            <div class="container-fluid">
                <h3 class="mb-4">Update Data Panitia</h3>
                <div class="form-container">
                    ...
                    if (isset($_GET['id_panitia'])) {
                        $id_panitia = input($_GET["id_panitia"]);
                        $sql = "SELECT * FROM tbl_panitia WHERE id_panitia=$id_panitia";
                        $hasil = mysqli_query($kon, $sql);
                        $data = mysqli_fetch_assoc($hasil);
                    }

                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        $id_panitia = htmlspecialchars($_POST["id_panitia"]);
                        $nama_panitia = input($_POST["nama_panitia"]);
                        $divisi = input($_POST["divisi"]);
                        $no_hp = input($_POST["no_hp"]);
                        $email_panitia = input($_POST["email_panitia"]);

                        $sql = "UPDATE tbl_panitia SET 
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_panitia" class="form-control" value="<?php echo $data['nama_panitia']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label>Divisi:</label>
                            <input type="text" name="divisi" class="form-control" value="<?php echo $data['divisi']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label>No HP:</label>
                        ...
                        <div class="form-group">
                            <label>Email:</label>
                            <input type="email" name="email_panitia" class="form-control" value="<?php echo $data['email_panitia']; ?>" required>
                        </div>
                        <input type="hidden" name="id_panitia" value="<?php echo $data['id_panitia']; ?>">
